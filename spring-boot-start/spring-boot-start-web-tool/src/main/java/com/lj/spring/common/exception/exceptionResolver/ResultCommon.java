...
public final class ResultCommon {
     ...
     * 错误请求 - 非法的参数
     */
    public static final Result INVALID_ARGUMENTS = ResultFail.of(1000101, "非法的参数");

    /**
     * 错误请求 - 服务内部错误
     */
    public static final Result INTERNAL_SERVER_ERROR = ResultFail.of(1000102, "服务内部错误");

    /**
     * 错误请求 - 资源未发现
     */
    public static final Result RESOURCE_NOT_FOUND = ResultFail.of(1000103, "资源未发现");

    /**
     * 错误请求 - 请求非法
     */
    public static final Result FORBIDDEN = ResultFail.of(1000104, "请求非法");
